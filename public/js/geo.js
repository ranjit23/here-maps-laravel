...
function geocode(platform) {
    var geocoder = platform.getGeocodingService(),
        geocodingParameters = {
            searchText: "dalal street kala ghoda",
            jsonattributes: 1
        };
...
var platform = new H.service.Platform({
    apikey: "cbl2Eo6lp-oJkEUITR7fsYSQv_AsO5uQ27gUr-HdcnA"
});
...
function addLocationsToPanel(locations) {
    ...
    for (i = 0; i < locations.length; i += 1) {
        ...
        content +=
            "<strong>postalCode:</strong> " + address.postalCode + "<br/>";
